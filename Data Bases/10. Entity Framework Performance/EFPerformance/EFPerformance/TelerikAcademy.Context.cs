...
namespace EFPerformance
{
    ...
    public partial class TelerikAcademyEntities : DbContext
    {
        ...
        public virtual DbSet<UsersThatLoggedToday> UsersThatLoggedTodays { get; set; }
        ...
        public virtual ObjectResult<string> usp_SelectEmployeesAndTownsThatMachPattern(string pattern)
        {
            var patternParameter = pattern != null ?
                new ObjectParameter("pattern", pattern) :
                new ObjectParameter("pattern", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("usp_SelectEmployeesAndTownsThatMachPattern", patternParameter);
        }
    }
}
