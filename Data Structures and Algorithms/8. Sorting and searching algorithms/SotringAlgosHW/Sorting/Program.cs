namespace SortingHomework
{
    ...
    internal class Program
    {
        ...
        {
            var collection = new SortableCollection<int>(new[] { 22, 11, 101, 33, 0, 101, 66, 1, 24, 47, 23 });
            ...
            collection = new SortableCollection<int>(new[] { 22, 11, 101, 33, 0, 101, 66, 1, 24, 47, 23 });
            ...
            Console.WriteLine("Linear search 16:");
            Console.WriteLine(collection.LinearSearch(16));
            Console.WriteLine();
