namespace TopNews.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TopNews.Models.TopNewsDbContext>
    {
        ...
        protected override void Seed(TopNewsDbContext context)
        {
            ...
            AppUser user = new AppUser() { UserName = "Anonymous" };
