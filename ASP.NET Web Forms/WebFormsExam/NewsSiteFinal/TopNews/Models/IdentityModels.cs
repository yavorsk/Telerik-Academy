...
namespace TopNews.Models
{
    ...
    public class TopNewsDbContext : IdentityDbContext<AppUser>
    {
        public TopNewsDbContext()
            : base("DefaultConnection", throwIfV1Schema: false)
        {
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<TopNewsDbContext, Configuration>());
        }

        public static TopNewsDbContext Create()
        {
            return new TopNewsDbContext();
        }
